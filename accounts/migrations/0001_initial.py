    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('role', models.CharField(choices=[('DOCTOR', 'Médecin'), ('NURSE', 'Infirmier'), ('PHARMACIST', 'Pharmacien'), ('ADMIN', 'Administrateur'), ('PATIENT', 'Patient')], max_length=15)),
                ('phone_number', models.CharField(max_length=17, unique=True, validators=[django.core.validators.RegexValidator(message="Le numéro de téléphone doit être au format: '+221771234567'.", regex='^\\+?1?\\d{9,15}$')])),
